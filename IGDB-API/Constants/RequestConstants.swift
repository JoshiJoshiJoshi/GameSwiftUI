...
struct RequestEndpoints {
    static let games = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Game._base)"
    
    static let ageRatings = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.AgeRating._base)"
    static let ageRatingContentDescriptions = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.AgeRatingContentDescription._base)"
    static let alternativeNames = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.AlternativeName._base)"
    static let artworks = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Artwork._base)"
    static let characters = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Character._base)"
    static let characterMugShots = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.CharacterMugShot._base)"
    static let collections = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Collection._base)"
    static let companies = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Company._base)"
    static let companyLogos = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.CompanyLogo._base)"
    static let companyWebsites = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.CompanyWebsite._base)"
    static let covers = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Cover._base)"
    static let externalGames = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.ExternalGame._base)"
    static let franchises = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Franchise._base)"
    static let gameEngines = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameEngine._base)"
    static let gameEngineLogos = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameEngineLogo._base)"
    static let gameModes = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameMode._base)"
    static let gameVersions = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameVersion._base)"
    static let gameVersionFeatures = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameVersionFeature._base)"
    static let gameVersionFeatureValues = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameVersionFeatureValue._base)"
    static let gameVideos = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.GameVideo._base)"
    static let genres = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Genre._base)"
    static let involvedCompanies = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.InvolvedCompany._base)"
    static let keywords = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Keyword._base)"
    static let multiplayerModes = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.MultiplayerMode._base)"
    static let platforms = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Platform._base)"
    static let platformFamilies = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.PlatformFamily._base)"
    static let platformVersions = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.PlatformVersion._base)"
    static let platformVersionCompanies = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.PlatformVersionCompany._base)"
    static let platformVersionReleaseDates = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.PlatformVersionReleaseDate._base)"
    static let platformWebsites = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.PlatformWebsite._base)"
    static let playerPerspectives = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.PlayerPerspective._base)"
    static let release_dates = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.ReleaseDate._base)"
    static let screenshots = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Screenshot._base)"
    static let search = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Search._base)"
    static let themes = "/\(Config.IGDB.currentApiVersion)/\(APIConstants.Theme._base)"
